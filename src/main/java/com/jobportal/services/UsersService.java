...
public class UsersService {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                RecruiterProfile recruiterProfile = recruiterProfileRepository.findById(userId)
                        .orElseGet(() -> createDefaultRecruiterProfile(users));
                return recruiterProfile;
            } else {
                JobSeekerProfile jobSeekerProfile = jobSeekerProfileRepository.findById(userId)
                        .orElseGet(() -> createDefaultJobSeekerProfile(users));
    ...
    private RecruiterProfile createDefaultRecruiterProfile(Users users) {
    ...
    private JobSeekerProfile createDefaultJobSeekerProfile(Users users) {
