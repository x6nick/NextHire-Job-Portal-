...
public interface JobPostActivityRepository extends JpaRepository<JobPostActivity, Integer> {
    ...
    @Modifying
    @Query(value = "DELETE FROM job_post_activity WHERE job_post_id = :jobId AND posted_by_id = :recruiterId", nativeQuery = true)
    int deleteRecruiterJob(@Param("jobId") int jobId, @Param("recruiterId") int recruiterId);
}
